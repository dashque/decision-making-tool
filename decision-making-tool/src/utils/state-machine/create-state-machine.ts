...
//     T extends EventType<Transitions>,
//     D extends Transitions[T],
//   >(event: { type: T; data: D }): StateMachineTransitionResult<State> {
//     const currentStateDefinition = this.definition.states[this.currentState];
//     const destinationTransition =
//       currentStateDefinition?.transitions?.[event.type];
//
...
//       actionType: A,
//       //TODO ESLint: Missing return type on function. (@typescript-eslint/explicit-function-return-type)
//     ) =>
//       Object.freeze({
//         type: actionType,
//         from: previousState,
...
//           //TODO TS6133: 'data' is declared but its value is never read.
//           data: unknown,
//           transition: T,
//         ): data is Transitions[T] => Object.is(transition, event.type),
//         owner: this,
//       });
//
...
//   }
//
//   public on<P extends Parameters<typeof this.emitter.on>>(
//     ...parameters: P
//   ): void {
//     return this.emitter.on.apply(this, parameters);
//   }
//
//   public off<P extends Parameters<typeof this.emitter.off>>(
//     ...parameters: P
//   ): void {
